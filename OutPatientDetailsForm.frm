...
Begin VB.Form OutPatientDetailsForm 
   BackColor       =   &H00FFFFC0&
   Caption         =   "OutPatientDetailsForm"
   ClientHeight    =   3090
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   4680
   ...
   Begin MSAdodcLib.Adodc Adodc1 
      ...
      Orientation     =   0
      Enabled         =   -1
      Connect         =   $"OutPatientDetailsForm.frx":0000
      OLEDBString     =   $"OutPatientDetailsForm.frx":008D
      OLEDBFile       =   ""
      DataSourceName  =   ""
      OtherAttributes =   ""
      UserName        =   ""
   ...
   End
End
Attribute VB_Name = "OutPatientDetailsForm"
